...
|---|---:|---:|---:|
| `compiler/parser.ts` (540 KB) | 78 µs | 122 µs | 9.1 ms |
| `compiler/checker.ts` (3.1 MB, one function of 2.9 MB) | 130 µs | 574 µs | 56 ms |
| Excalidraw `components/App.tsx` (465 KB) | 83 µs | 225 µs | 9.6 ms |
